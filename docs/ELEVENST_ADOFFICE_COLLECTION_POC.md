...
| 구분 | 번호 | URL | 제목 |
| --- | --- | --- | --- |
| new_page | 1 | `about:blank` | Loading https://adoffice.11st.co.kr/ |

## 9. 자동 실행 환경 한계

- 자동 관찰 상태: failed
- 자동 관찰 상세: Page.goto: net::ERR_NETWORK_ACCESS_DENIED at https://adoffice.11st.co.kr/
Call log:
  - navigating to "https://adoffice.11st.co.kr/", waiting until "load"
...
현재 11번가는 실제 광고 계정 검증 전 단계입니다.

진행 가능 작업:

- 애드오피스 접속 URL 확인
- 사용자가 직접 로그인한 뒤 리포트 메뉴 구조 확인
- 다운로드 가능 파일 구조 확인

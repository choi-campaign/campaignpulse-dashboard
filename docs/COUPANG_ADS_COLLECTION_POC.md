...
- 전용 수집 브라우저 실행: 검증 대상
- 공식 진입 URL: `https://advertising.coupang.com/`
- 로그인 인증: 미검증
- 광고센터 진입: 미검증
- 리포트 다운로드: 미검증
...
- 대상 profile: `coupang_ads`
- 대상 매체: 쿠팡
- 시작 URL: `https://advertising.coupang.com/`
- 관찰 상태: failed
- 새 페이지/팝업 감지 수: 1
- 관찰 증거 파일: `C:\Users\admin\Documents\Codex\2026-06-07\aimaos-ai-marketing-association-operating-system\outputs\aimaos_mvp\data\collection_poc\marketplace\coupang_ads\ad_center_entry_20260611_042257.json`
...
| 구분 | 번호 | URL | 제목 |
| --- | --- | --- | --- |
| new_page | 1 | `about:blank` | Loading https://advertising.coupang.com/ |

## 9. 자동 실행 환경 한계

- 자동 관찰 상태: failed
- 자동 관찰 상세: Page.goto: net::ERR_NETWORK_ACCESS_DENIED at https://advertising.coupang.com/
Call log:
  - navigating to "https://advertising.coupang.com/", waiting until "load"
...
구조 준비 단계입니다. 공식 진입 URL과 전용 브라우저 구조는 준비했지만, 실제 로그인, 리포트 화면, 다운로드 파일 구조는 아직 계정 기반 검증이 필요합니다.
## 9. 2026-06-11 Night Build 반영

쿠팡은 현재 위험 매체로 유지합니다.

이유:

- 광고센터 인증 구조와 보안 정책 확인 필요
- 다운로드 가능성 검증 전
- 자동화 브라우저 사용에 대한 정책 리스크 확인 필요

현재 상태: 구조 조사 문서화 완료, 실제 계정 기반 POC는 후순위.

...
def get_profile(project_root: Path) -> MarketplaceProfile:
    downloads, browser_profile = profile_dirs(project_root, "auction", "next")
    return MarketplaceProfile(
        media_key="auction",
        media_name="옥션",
        profile_version="next",
        login_url_env_key="AIMAOS_POC_AUCTION_NEXT_LOGIN_URL",
        report_url_env_key="AIMAOS_POC_AUCTION_NEXT_REPORT_URL",
        selectors={},
